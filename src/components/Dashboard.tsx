...
PS:合计行和江西省固定显示不受影响
b. 市本级：勾选时，下方市级单位的装备计数需要包括本级数量；受影响的列有（现有总数、人均配备数量、报废总数、缺口数量）
c. 县区：勾选时，下方市级单位的装备计数需要包括下级的县区数量；县区节点判断规则见钉钉文档中的说明
d. 功能区：勾选时，下方市级单位的装备计数需要包括下级的功能区数量；功能区列表见钉钉文档中的说明
